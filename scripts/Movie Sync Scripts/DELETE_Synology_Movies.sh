...
################################################################################
# PROJECT MOTHER - SYNOLOGY DELETION SCRIPT (Movies)
################################################################################
#
# RUNS ON: Mother server
# DELETES: Chris's lower quality movies
# DESTINATION: /mnt/synology/rs-4kmedia/deleted/movies/
#
# This script moves Chris's lower quality movie files to the deleted folder.
# Files are moved (not permanently deleted), so you can recover them if needed.
#
# USAGE:
#   1. Run in dry-run mode: bash DELETE_Synology_Movies.sh
#   2. Review the output
#   3. Edit this file: Change EXECUTE=false to EXECUTE=true
#   4. Run again: bash DELETE_Synology_Movies.sh
#
################################################################################
...
move_to_deleted() {
  ...
  local dest="/mnt/synology/rs-4kmedia/deleted/movies/${movie_folder}/"
...
################################################################################
# DELETIONS: Chris's Lower Quality Movies
################################################################################
...
echo "========================================================================"
echo "SYNOLOGY MOVIES DELETION"
echo "========================================================================"
echo "Deleting Chris's lower quality movies..."
echo "Destination: /mnt/synology/rs-4kmedia/deleted/movies/"
echo ""
...
echo "========================================================================"
if [ "$EXECUTE" = "true" ]; then
  echo "COMPLETE: Files moved to /mnt/synology/rs-4kmedia/deleted/movies/"
else
  ...
  echo "  3. Run: bash DELETE_Synology_Movies.sh"
fi
echo "========================================================================"
