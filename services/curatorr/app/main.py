...
try:
    ...
    _fh = _RFH(_log_dir / 'curatorr.log', maxBytes=20 * 1024 * 1024, backupCount=6)
...
from app.routes import sync, movies, tv, stats, collections, duplicates, rules, deletion_log, settings, actions, logs, sync_status, pipeline
